...
module.exports.run = async function({ api, event }) {
        ...
        if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
                ...
                const fs = require("fs");
                return api.sendMessage("Assalamu Alaikum Everyone🥀🥀", event.threadID, () => api.sendMessage({body:`𝐑𝐀𝐉 𝐗𝐖𝐃🧸 CONNECTED«

Bot Made By 𝐑𝐀𝐉 𝐗𝐖𝐃⚠️
<------------------------------>  
...
OWNER: 🧸𝐑𝐀𝐉 𝐗𝐖𝐃 & 𝐏𝐑𝐈𝐘𝐀𝐍𝐒𝐇 𝐑𝐀𝐉𝐎𝐔𝐓🧸

♻️Facebook: https://www.facebook.com/profile.php?id=61583409240142
